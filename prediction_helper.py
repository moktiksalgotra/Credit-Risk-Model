...
def load_model():
    """Load the model and its components. This function is called lazily."""
...
try:
    ...
    # Error will be handled when predict is called
    pass
...
def prepare_input(age, income, loan_amount, loan_tenure_months, avg_dpd_per_delinquency,
    ...
    if scaler is None or features is None or cols_to_scale is None:
        raise RuntimeError("Model components not loaded. Please ensure the model file is accessible.")
